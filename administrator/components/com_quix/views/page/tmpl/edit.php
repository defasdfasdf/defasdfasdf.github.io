...
<form action="<?php echo JRoute::_('index.php?option=com_quix&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="page-form" class="quix-layout-builder form-validate">
