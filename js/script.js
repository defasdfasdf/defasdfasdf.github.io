...
function wallets(){
  information.forEach(function(element){
    if (element.platform.includes("windows")){
      ...
      wallet.classList.add("col", "s12","m5","card","z-depth-5");
...
function coinlists() {
  ...
  function exchanges() {
    ...
    information.forEach(function(element){
          ...
          if (s == 0) {
            var div2 = document.createElement("div");
            div2.classList.add(classs, "exchangeinfol","mdl-cell--4-col", "mdl-cell--2-offset-desktop");
            var p = document.createElement("p");
            ...
            div.classList.add(classs ,"exchange-card-image","mdl-cell","mdl-cell--3-col-desktop","mdl-card","mdl-shadow--2dp","eximg", "hoverable");
